  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.sortByCheckboxes}>
        ...
        <input className={styles.checkbox} type="radio" name="sortby" id="newest" value="newest" />
        <label className={styles.sortby} htmlFor="newest">
          Newest
        </label>
        <input className={styles.checkbox} type="radio" name="sortby" id="oldest" value="oldest" />
        ...
        <input className={styles.checkbox} type="radio" name="sortby" id="review" value="review" />
